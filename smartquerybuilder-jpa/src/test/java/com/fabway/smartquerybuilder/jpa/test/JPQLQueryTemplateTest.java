...
import com.fabway.smartquerybuilder.jpa.builders.JPQLQueryTemplate;

public class JPQLQueryTemplateTest {

    JPQLQueryTemplate tpl;

    @Before
    public void setUp() {
        this.tpl = new JPQLQueryTemplate();
    }

    private void verifyTemplateBuffers(JPQLQueryTemplate template, Function<JPQLQueryTemplate, TextBuffer> getBuffer,
            BiConsumer<JPQLQueryTemplate, String> call) {
